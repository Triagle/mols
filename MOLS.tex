...
\begin{document}
    \info[inline]{Super rough draft, some direction on writing style, proof techniques, etc, would be greatly appreciated!}
...
\end{proof}
    ...
    \end{proof}
    \todo[inline]{Proof of equivalence is not yet shown (but strongly held belief exists).}
